...
export default function AppGrid({ links = [], onDelete, onEdit }: AppGridProps) {
  ...
  return (
    <div className="app-grid-container grid-z-index-fix">
      ...
      >
        {links.map((link, index) => (
          ...
          >
            ...
            >
              <div className="aspect-square bg-[#444444] relative overflow-hidden">
                {link.imageUrl ? (
                  <img
